    ...
    const listaCarros = [
        {
            ...
            location: "São Paulo",
            description: "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Mauris ornare, est sed lobortis rutrum, risus dolor finibus arcu, nec tincidunt dui sapien ac nunc. Mauris tincidunt purus a sapien rhoncus, ac efficitur ante iaculis. Morbi rhoncus ornare faucibus. Nullam semper, tellus sed porta auctor, ligula ex mollis sapien, ac lacinia orci turpis ac lectus. Class aptent taciti sociosqu ad litora torquent per conubia nostra, per inceptos himenaeos. Quisque ante metus, ultrices eu odio viverra, condimentum semper lacus. Phasellus sit amet interdum felis. Proin sit amet rhoncus purus. Curabitur tempus eros urna, ac aliquet lacus elementum ut. Duis et tortor congue."
        },
        {
